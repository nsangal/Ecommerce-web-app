...
export class SignUpComponent implements OnInit {
  ...
  usernameTaken: boolean = false; // Track if the username is taken
  firstInvalidField: string | null = null; // Track the first invalid field
  ...
  // Method to clear errors when the user starts typing
